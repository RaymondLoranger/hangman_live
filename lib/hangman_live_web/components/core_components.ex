defmodule Hangman.LiveWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info &&
          "bg-emerald-50 fill-cyan-900 text-emerald-800 ring-emerald-500",
        @kind == :error &&
          "bg-rose-50 fill-rose-900 text-rose-900 shadow-md ring-rose-500"
      ]}
      {@rest}
    >
      <p
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(Hangman.LiveWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(Hangman.LiveWeb.Gettext, "errors", msg, opts)
    # end
